...
func main() {
	...
	// or you can take the shorcut
	jim.updateFirstName("Juanito")
	jim.print()

}

// To point the function receiver to a pointer adress you have to prepend a * to the type,
// it means that you are summoning a POINTER type and not its value, example *person
